...
const tableBucketName = `axon-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `axon-${$app.stage}-lake-ingest`,
    destination: "iceberg",
