...
Desktop application and browser-based app issues, including `axon web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core axon server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Axon Zen, Axon Go, and billing issues.
