...
- PR #13942: https://github.com/Wade-DevCode/axon/pull/13942

## Do Not Translate (Locale Additions)

- `Axon` (preserve casing in prose; keep `axon` only when it is part of commands, package names, paths, or code)
- `Axon Zen`
- `Axon CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `axon` in prose when referring to the product name; use `Axon`
