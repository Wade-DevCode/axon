...
Use this folder for locale-specific translation guidance that supplements `.axon/agent/translator.md`.
...
- PR #12345: https://github.com/Wade-DevCode/axon/pull/12345

## Do Not Translate (Locale Additions)

- `Axon` (preserve casing)
