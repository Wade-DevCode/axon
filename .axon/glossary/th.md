...
- PR #10809: https://github.com/Wade-DevCode/axon/pull/10809
- PR #11496: https://github.com/Wade-DevCode/axon/pull/11496

## Do Not Translate (Locale Additions)

- `Axon` (preserve casing in prose; keep `axon` only in commands, package names, paths, or code)
- `Axon CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
