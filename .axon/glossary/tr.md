...
- PR #15835: https://github.com/Wade-DevCode/axon/pull/15835

## Do Not Translate (Locale Additions)

- `Axon` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `axon` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Axon` in prose, `axon` only for exact technical identifiers
...
- Avoid changing `axon` to `Axon` inside commands, URLs, package names, or code literals
