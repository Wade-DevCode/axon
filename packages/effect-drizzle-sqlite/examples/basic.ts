...
class Database extends Context.Service<Database, DatabaseShape>()("@axon/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@axon/example/UserStore") {
