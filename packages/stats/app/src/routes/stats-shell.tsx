import axonWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/Wade-DevCode/axon",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Axon on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "axon:stats-theme"
...
function AxonMark() {
  return (
    <svg data-slot="axon-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const connect = [
    ...
    { href: "https://github.com/Wade-DevCode", label: "GitHub" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://opencode.ai" aria-label="Axon home">
          <AxonMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={axonWordmarkDark} alt="Axon" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Axon Newsletter</h2>
            <p>
