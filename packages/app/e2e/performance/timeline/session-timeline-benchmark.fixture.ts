...
import { mockAxonServer } from "../../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../../utils/waits"
import { expect } from "../benchmark"

const directory = "C:/Axon/TimelineStateRegression"
...
const model = { providerID: "axon", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["axon"],
    default: { providerID: "axon", modelID: "claude-opus-4-6" },
  }
}
