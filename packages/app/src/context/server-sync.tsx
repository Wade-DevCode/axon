import type { Config, AxonClient, Path, Project, ProviderAuthResponse } from "@axon-ai/sdk/v2/client"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: AxonClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: AxonClient) =>
  queryOptions({
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, AxonClient>()
