...
import { ResizeHandle } from "@axon-ai/ui/resize-handle"
...
import { getFilename } from "@axon-ai/core/util/path"
import { Session } from "@axon-ai/sdk/v2/client"
...
import { toaster } from "@axon-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@axon-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  function openSettings() {
    const run = ++dialogRun
    const module = vscode || settings.general.newLayoutDesigns()
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/Wade-DevCode/axon/issues/new")}
      renderPanel={() =>
