...
beforeAll(async () => {
  ...
  mock.module("@axon-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@axon-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@axon-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@axon-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
