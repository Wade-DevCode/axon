import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@axon-ai/sdk/v2/client"
import { Button } from "@axon-ai/ui/button"
import { useDialog } from "@axon-ai/ui/context/dialog"
import { Dialog } from "@axon-ai/ui/dialog"
import { Icon } from "@axon-ai/ui/icon"
import { IconButton } from "@axon-ai/ui/icon-button"
import { List, type ListRef } from "@axon-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "axon"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.axonZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.axonZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.axonZen.visit.prefix")}
                <Link href="https://github.com/Wade-DevCode/axon#configuration" tabIndex={-1}>
                  {language.t("provider.connect.axonZen.visit.link")}
                </Link>
                {language.t("provider.connect.axonZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
