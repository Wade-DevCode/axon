export const dict = {
  ...
  "dialog.provider.axon.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.axon.tagline": "Reliable optimized models",
  "dialog.provider.axonGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Axon",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Axon.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.axonZen.line1":
    "Axon Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.axonZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.axonZen.visit.prefix": "Visit ",
  "provider.connect.axonZen.visit.link": "opencode.ai/zen",
  "provider.connect.axonZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Axon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Axon.",
  ...
  "dialog.plugins.empty": "Plugins configured in axon.json",
  ...
  "dialog.server.description": "Switch which Axon server this app connects to.",
  ...
  "wsl.onboarding.checkingAxon": "Checking Axon...",
  "wsl.onboarding.checkingAxonIn": "Checking Axon in {{distro}}...",
  "wsl.onboarding.updatingAxon": "Updating Axon...",
  "wsl.onboarding.updatingAxonIn": "Updating Axon in {{distro}}...",
  "wsl.onboarding.updateAxonIn": "Update Axon in {{distro}}.",
  "wsl.onboarding.updateAxon": "Update Axon",
  "wsl.onboarding.axonReadyIn": "Axon is ready in {{distro}}.",
  "wsl.onboarding.axonReady": "Axon is ready.",
  "wsl.onboarding.installAxonIn": "Install Axon in {{distro}}.",
  "wsl.onboarding.installAxon": "Install Axon",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Axon.",
  ...
  "toast.update.description": "A new version of Axon ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Axon team",
  ...
  "error.chain.checkConfig": "Check your config (axon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Axon does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Axon includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Axon server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Axon",
  ...
  "settings.general.row.appearance.description": "Customise how Axon looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Axon follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Axon is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Axon launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Axon.",
