export const dict = {
  ...
  "dialog.provider.axon.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.axon.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.axonGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Axon",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Axon-u.",
  ...
  "provider.connect.axonZen.line1":
    "Axon Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.axonZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.axonZen.visit.prefix": "Posjeti ",
  "provider.connect.axonZen.visit.link": "opencode.ai/zen",
  "provider.connect.axonZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Axon-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Axon-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u axon.json",
  ...
  "dialog.server.description": "Promijeni na koji se Axon server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Axon-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Axon timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (axon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Axon još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Axon uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Axon server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Axon-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Axon izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Axon prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Axon-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Axon pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Axon-a.",
