export const dict = {
  ...
  "toast.update.description":
    "Une nouvelle version d'Axon ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "Axon inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
