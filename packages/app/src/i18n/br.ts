export const dict = {
  ...
  "dialog.provider.axon.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.axon.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.axonGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Axon",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Axon.",
  ...
  "provider.connect.axonZen.line1":
    "Axon Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.axonZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.axonZen.visit.prefix": "Visite ",
  "provider.connect.axonZen.visit.link": "opencode.ai/zen",
  "provider.connect.axonZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Axon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Axon.",
  ...
  "dialog.plugins.empty": "Plugins configurados em axon.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Axon este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Axon ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Axon",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (axon.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Axon ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Axon inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Axon dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Axon",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Axon aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Axon segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Axon é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Axon iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Axon.",
