...
export const dict = {
  ...
  "dialog.provider.axon.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.axon.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.axonGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Axon tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Axon'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.axonZen.line1":
    "Axon Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Axon'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler axon.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Axon sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Axon'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Axon ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (axon.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Axon henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Axon ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Axon Masaüstü",
  ...
  "settings.desktop.wsl.description": "Axon sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Axon'un görünüm dilini değiştirin",
  ...
  "settings.updates.row.startup.description": "Axon başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Axon'un en son sürümünü kullanıyorsunuz.",
