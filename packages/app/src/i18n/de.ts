...
export const dict = {
  ...
  "dialog.provider.axon.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.axon.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.axonGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Axon",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Axon zu nutzen.",
  ...
  "provider.connect.axonZen.line1":
    "Axon Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.axonZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.axonZen.visit.link": "opencode.ai/zen",
  "provider.connect.axonZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Axon zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Axon zu nutzen.",
  ...
  "dialog.plugins.empty": "In axon.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Axon-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Axon ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Axon-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (axon.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Axon unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Axon enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Axon-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Axon ändern",
  ...
  "settings.updates.row.startup.description": "Beim Start von Axon automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Axon.",
