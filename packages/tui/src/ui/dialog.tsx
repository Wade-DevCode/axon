...
import { useBindings, useAxonModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useAxonModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.AXON_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
