...
const TIPS: Tip[] = [
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.axon/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.axon/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.axon/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.axon/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent Axon from reading sensitive files",
  "Use {highlight}axon run{/highlight} for non-interactive scripting",
  "Use {highlight}axon --continue{/highlight} to resume the last session",
  "Use {highlight}axon run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}axon serve{/highlight} for headless API access to Axon",
  "Use {highlight}axon run --attach{/highlight} to connect to a running server",
  ...
  "Run {highlight}axon debug config{/highlight} to troubleshoot configuration",
