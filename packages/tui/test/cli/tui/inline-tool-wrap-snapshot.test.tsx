...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/axon (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/axon/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/axon/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AXON_DB|AXON_DB|AXON_DEV|Global\\.Path\\.data|data =" in packages/axon/src (115 matches)',
  },
] as const
