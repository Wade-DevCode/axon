...
> current private `@axon-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@axon-ai/ai`
...
- Secondary audience: Axon and other durable agent runtimes
...
import { LLM } from "@axon-ai/ai"
import { OpenAI } from "@axon-ai/ai/providers/openai"
...
```ts
import { Message } from "@axon-ai/ai"
...
import { LLM, Tool } from "@axon-ai/ai"
...
Axon and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@axon-ai/ai/promise"
import { OpenAI } from "@axon-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@axon-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@axon-ai/ai/provider"
...
@axon-ai/ai/providers/openai
@axon-ai/ai/providers/anthropic
@axon-ai/ai/providers/google
...
```
...
Axon should migrate to `generateTurn` / `streamTurn`, preserving its durable
