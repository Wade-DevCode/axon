...
Schema-first LLM core for axon. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@axon-ai/llm"
import { OpenAI } from "@axon-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@axon-ai/llm/providers"
