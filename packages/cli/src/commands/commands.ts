...
declare const AXON_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AXON_CLI_NAME === "string" ? AXON_CLI_NAME : "axon", {
  description: "Axon 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
