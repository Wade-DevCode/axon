...
import { Database, eq, and, isNull } from "@axon-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@axon-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#axon-go")} target="_blank" rel="noopener noreferrer">
