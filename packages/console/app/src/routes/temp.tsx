    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>axon-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>axon-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>axon</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://github.com/Wade-DevCode">Developer</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/Wade-DevCode/axon">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/Wade-DevCode/axon/issues">Support</a>
          </div>
        </footer>
      </div>
