...
import desktopAppIcon from "../../asset/lander/axon-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g axon-ai")}>
                <code>
                  npm i -g <strong>axon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g axon-ai")}>
                <code>
                  bun add -g <strong>axon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/axon")}>
                <code>
                  brew install <strong>anomalyco/tap/axon</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S axon")}>
                <code>
                  paru -S <strong>axon</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask axon-desktop")}>
                <code>
                  brew install --cask <strong>axon-desktop</strong>
                </code>
                <CopyStatus />
              </button>
