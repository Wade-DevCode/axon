...
import compareVideo from "../../asset/lander/axon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/axon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="axon:auth" content={loggedin() ? "true" : "false"} />
