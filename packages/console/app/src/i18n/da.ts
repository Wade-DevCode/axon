...
export const dict = {
  ...
  "home.privacy.body":
    "Axon gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  ...
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Axon kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
