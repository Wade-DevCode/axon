...
- Effect plugins import `@axon-ai/plugin/v2/effect`, not `@axon-ai/core`.
- Public domain values use generated `@axon-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@axon-ai/plugin/v2/effect`.
