...
Možete dodati prilagođene komande kroz Axon konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Axon [config](/docs/config):
...
- Globalno: `~/.axon/commands/`
- Po projektu: `.axon/commands/`
...
Axon uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
