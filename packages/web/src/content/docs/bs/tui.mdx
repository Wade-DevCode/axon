---
title: TUI
description: Korištenje korisničkog interfejsa Axon terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Axon pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Axon pokreće TUI za trenutni direktorij.
...
Kada koristite Axon TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Axon. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Axon. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `axon.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Axon čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `axon.default`.
