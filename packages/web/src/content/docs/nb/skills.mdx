...
Agentferdigheter lar Axon oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går axon opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
axon viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `axon.json`:
