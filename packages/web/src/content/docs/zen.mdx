---
title: Zen
description: Curated list of models provided by Axon.
---
...
Axon Zen is a list of tested and verified models provided by the Axon team.

Zen works like any other provider in Axon. You login to Axon Zen and get
...
:::tip
We tested a select group of models and providers that work well with Axon.
:::
...
Axon Zen is an AI gateway that gives you access to these models.

---

## How it works

Axon Zen works like any other provider in Axon.

1. You sign in to **<a href={console}>Axon Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Axon Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Axon config
uses the format `axon/<model-id>`. For example, for GPT 5.5, you would
use `axon/gpt-5.5` in your config.
...
- DeepSeek V4 Flash Free is available on Axon for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on Axon for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on Axon for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on Axon for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Axon for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Axon as well.
