...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في axon.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في axon مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.axon/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.axon/tools/`.
