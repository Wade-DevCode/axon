...
Brug den til at bygge integrasjoner og kontrollere axon programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `axon.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av axon, kan du oprete en klientforekomst for at koble til den:
