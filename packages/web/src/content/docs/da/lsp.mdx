---
title: LSP-servere
description: Axon integreres med dine LSP-servere.
---

Axon kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Axon leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `AXON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og axon åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din axon-konfiguration.
