...
description: Opret værktøjer, som LLM kan kalde axon ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med axons [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.axon/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.axon/tools/`.
