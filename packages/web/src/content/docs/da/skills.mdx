...
Agentferdigheter lar Axon oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Axon søker etter disse stedene:

- Prosjektkonfigurasjon: `.axon/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.axon/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Axon opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.axon/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.axon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.axon/skills/git-release/SKILL.md` slik:
...
Axon viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `axon.json`:
...
**For innebygde agenter** (i `axon.json`):
