---
title: Zen
description: axon tarafından sağlanan seçilmiş modeller listesi.
---
...
Axon Zen, Axon ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Axon'daki diğer sağlayıcılar gibi çalışır. Axon Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Axon kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Axon ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Axon Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Axon Zen, Axon'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Axon Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Axon Zen'i seçin ve API anahtarınızı yapıştırın.
...
Axon yapılandırmanızdaki [model id](/docs/config/#models) `axon/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `axon/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Axon'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Axon'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Axon'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Axon'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Axon'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Axon Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Axon ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
