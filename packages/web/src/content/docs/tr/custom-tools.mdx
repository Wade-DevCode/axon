---
title: Özel Araçlar
description: LLM'un axon'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. axon'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.axon/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.axon/tools/` içine yerleştirerek.
