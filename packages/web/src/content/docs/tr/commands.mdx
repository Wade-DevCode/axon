...
axon işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

axon [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.axon/commands/`
- Proje başına: `.axon/commands/`
...
axon, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
