---
title: Paylasim
description: axon konusmalarini genel baglantilarla paylasin.
---

axon'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda axon:
...
axon, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak axon manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `axon.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda axon kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
