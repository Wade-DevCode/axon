---
title: Zen
description: Liste organisée de modèles fournis par Axon.
---
...
Axon Zen est une liste de modèles testés et vérifiés fournie par l'équipe Axon.

Zen fonctionne comme n'importe quel autre fournisseur dans Axon. Vous vous connectez à Axon Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Axon.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Axon.
:::
...
Axon Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Axon Zen fonctionne comme n'importe quel autre fournisseur dans Axon.

1. Vous vous connectez à **<a href={console}>Axon Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Axon Zen et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration Axon utilise le format `axon/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `axon/gpt-5.5` dans votre configuration.
...
- DeepSeek V4 Flash Free est disponible sur Axon pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur Axon pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur Axon pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur Axon pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Axon pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Axon également.
