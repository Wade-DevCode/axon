...
Erstellen Sie `.axon/commands/test.md`:

```md title=".axon/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Axon-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Axon [config](/docs/config):

```json title="axon.jsonc" {4-12}
{
...
- Global: `~/.axon/commands/`
- Pro Projekt: `.axon/commands/`

```markdown title="~/.axon/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".axon/commands/component.md"
---
...
```md title=".axon/commands/create-file.md"
---
...
```md title=".axon/commands/analyze-coverage.md"
---
...
```md title=".axon/commands/review-changes.md"
---
...
```md title=".axon/commands/review-component.md"
---
...
Axon enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
