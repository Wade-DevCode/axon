---
title: Teilen
description: Teile Axon-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Axon-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Axon Folgendes:
...
Axon hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Axon den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`axon.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du axon in deiner Organisation einsetzt.
