...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Axon:
...
- ระดับผู้ใช้ (Global): `~/.axon/commands/`
- ระดับโปรเจ็กต์: `.axon/commands/`
...
Axon มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
