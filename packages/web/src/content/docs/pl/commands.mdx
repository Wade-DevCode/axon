...
Możesz zdefiniować polecenia w `axon.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji axon:
...
- Globalnie: `~/.axon/commands/`
- Na projekt: `.axon/commands/`
...
axon zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
