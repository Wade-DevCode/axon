---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala axon.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

axon zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie axon uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI axon, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do axon. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `axon.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Axon czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `axon.default`.
