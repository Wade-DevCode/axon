...
Puede agregar comandos personalizados a través de la configuración Axon o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Axon [config](/docs/config):
...
axon incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
