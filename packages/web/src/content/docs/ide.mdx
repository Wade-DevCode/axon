---
title: IDE
description: The Axon extension for VS Code, Cursor, and other IDEs
---

Axon integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `axon` in the terminal to get started.
...
To install Axon on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `axon` - the extension installs automatically
...
Search for **Axon** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `axon` in the integrated terminal.
