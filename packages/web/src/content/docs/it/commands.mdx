...
Puoi aggiungere comandi personalizzati tramite la config di Axon o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Axon:
...
- Globale: `~/.axon/commands/`
- Per progetto: `.axon/commands/`
...
axon include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
