...
description: Crea strumenti che l'LLM puo chiamare in axon.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di axon come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.axon/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.axon/tools/`.
