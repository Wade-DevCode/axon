...
import { IconAxon } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "axon/session/message-v2"
import type { Message } from "axon/session/message"
import type { Session } from "axon/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.axon_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.axon_name}>
                    <IconAxon width={16} height={16} />
                  </div>
