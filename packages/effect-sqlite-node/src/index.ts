...
export const TypeId: TypeId = "~@axon-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@axon-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@axon-ai/effect-sqlite-node/NodeSqliteClient")
