...
import { AbsolutePath, type DeepMutable } from "@axon-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@axon/Agent") {}
