...
import { normalizePromptContent } from "@axon-ai/tui/editor"
...
import { AXON_BASE_MODE, useBindings } from "@axon-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Axon" } satisfies SlashOption,
    ]
