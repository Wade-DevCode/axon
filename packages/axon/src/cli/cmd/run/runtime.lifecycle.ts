...
import { openEditor } from "@axon-ai/tui/editor"
import { registerAxonKeymap } from "@axon-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerAxonKeymap(keymap, renderer, input.tuiConfig)
