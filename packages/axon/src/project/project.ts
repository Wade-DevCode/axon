...
import { ProjectDirectoryTable, ProjectTable } from "@axon-ai/core/project/sql"
...
import { which } from "@axon-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@axon/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AXON_FAKE_VCS)
