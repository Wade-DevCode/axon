...
import { EventSequenceTable, EventTable } from "@axon-ai/core/event/sql"
...
import { WorkspaceEvent } from "@axon-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@axon/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AXON_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AXON_WORKSPACE_ID: config.id,
        AXON_EXPERIMENTAL_WORKSPACES: "true",
