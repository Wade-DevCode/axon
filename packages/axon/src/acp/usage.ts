...
import type { AssistantMessage as AxonAssistantMessage, Message } from "@axon-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<AxonAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<AxonAssistantMessage, "role"> &
  Partial<Pick<AxonAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@axon/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@axon/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@axon/ACPUsage") {}
