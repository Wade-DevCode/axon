...
import { llmClient } from "@axon-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@axon-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@axon-ai/llm/route"
import type { LLMClientService } from "@axon-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@axon/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via axon's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @axon-ai/llm. It
