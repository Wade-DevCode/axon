...
import { buildPrompt } from "@axon-ai/core/session/compaction"
import { SessionCompactionEvent } from "@axon-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@axon/SessionCompaction") {}
