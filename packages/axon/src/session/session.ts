...
import { PartTable, SessionTable } from "@axon-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@axon-ai/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProviderV2 } from "@axon-ai/core/provider"
import { ModelV2 } from "@axon-ai/core/model"
import { SessionMessageID } from "@axon-ai/schema/session-message-id"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".axon", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@axon/Session") {}
