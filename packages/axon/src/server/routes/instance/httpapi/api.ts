...
import { makeApi } from "@axon-ai/protocol/api"
import { LocationMiddleware } from "@axon-ai/server/location"
import { SessionLocationMiddleware } from "@axon-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("axon-root")
...
export const InstanceHttpApi = HttpApi.make("axon-instance")
...
export const AxonHttpApi = HttpApi.make("axon")
