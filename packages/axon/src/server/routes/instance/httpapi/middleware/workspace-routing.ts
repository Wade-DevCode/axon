...
>()("@axon/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@axon/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AXON_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AXON_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-axon-directory"] || process.cwd()
}
