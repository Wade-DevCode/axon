 ...
 *   "@axon/ServerAuthConfig",
 *   {
 *     password: Config.string("AXON_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AXON_SERVER_USERNAME").pipe(Config.withDefault("axon")),
 *   },
 * ) {}
 *
