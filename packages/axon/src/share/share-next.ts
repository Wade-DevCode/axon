...
import type * as SDK from "@axon-ai/sdk/v2"
...
import { SessionShareTable } from "@axon-ai/core/share/sql"
import { ProviderV2 } from "@axon-ai/core/provider"
import { ModelV2 } from "@axon-ai/core/model"
import { EventV2 } from "@axon-ai/core/event"

const disabled = process.env["AXON_DISABLE_SHARE"] === "true" || process.env["AXON_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@axon/ShareNext") {}
