...
export class Service extends Context.Service<Service, Interface>()("@axon/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AXON_PHOTON_WASM_PATH?: string }).__AXON_PHOTON_WASM_PATH =
