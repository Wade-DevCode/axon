...
Practical reference for the current tool-migration state in `packages/axon`.
...
Tool tests should use the existing Effect helpers in `packages/axon/test/lib/effect.ts`:
