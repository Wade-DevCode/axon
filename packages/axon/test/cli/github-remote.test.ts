...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Wade-DevCode/axon.git")).toEqual({
    owner: "Wade-DevCode",
    repo: "axon",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Wade-DevCode/axon")).toEqual({ owner: "Wade-DevCode", repo: "axon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/axon.git")).toEqual({ owner: "sst", repo: "axon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/axon")).toEqual({ owner: "sst", repo: "axon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/axon.git")).toEqual({ owner: "sst", repo: "axon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/axon")).toEqual({ owner: "sst", repo: "axon" })
})
