...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips axon-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-axon-directory"]).toBeUndefined()
      expect(forwarded["x-axon-workspace"]).toBeUndefined()
