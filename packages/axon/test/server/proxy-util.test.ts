...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips axon-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-axon-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-axon-directory")).toBeNull()
      expect(result.get("x-axon-workspace")).toBeNull()
