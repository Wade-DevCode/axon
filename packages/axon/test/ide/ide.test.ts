...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AXON_CALLER", () => {
    process.env["AXON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AXON_CALLER", () => {
    process.env["AXON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AXON_CALLER", () => {
    process.env["AXON_CALLER"] = "unknown"
