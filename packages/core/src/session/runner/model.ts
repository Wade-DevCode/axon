...
import { type Model } from "@axon-ai/llm"
import * as AnthropicMessages from "@axon-ai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@axon-ai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@axon-ai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@axon-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@axon/v2/SessionRunnerModel") {}
