...
import type { EffectDrizzleSqlite } from "@axon-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@axon/ProjectDirectories") {}
