...
import { ProjectDirectoriesEvent } from "@axon-ai/schema/project-directories"
import { ProjectCopy } from "@axon-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@axon/ProjectCopy") {}
