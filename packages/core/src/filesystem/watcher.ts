...
import { FileSystemWatcher } from "@axon-ai/schema/filesystem-watcher"
...
declare const AXON_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AXON_LIBC === "undefined" ? undefined : AXON_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@axon/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AXON_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.AXON_EXPERIMENTAL_FILEWATCHER) {
