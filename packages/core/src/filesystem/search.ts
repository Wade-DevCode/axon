...
export class Service extends Context.Service<Service, Interface>()("@axon/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.AXON_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
