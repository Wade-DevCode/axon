...
const releaseId = process.env.AXON_RELEASE
if (!releaseId) throw new Error("AXON_RELEASE is required")

const version = process.env.AXON_VERSION
if (!version) throw new Error("AXON_VERSION is required")
...
const macxTarGz = "axon-desktop-mac-x64.app.tar.gz"
const macaTarGz = "axon-desktop-mac-arm64.app.tar.gz"
