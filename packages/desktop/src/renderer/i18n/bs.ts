export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Axon-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Axon-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
