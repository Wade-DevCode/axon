...
Generates UPCOMING_CHANGELOG.md by running the axon changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for axon run (default: low)
      --quiet            Suppress axon command output unless it fails
...
const cmd = [process.env.AXON_BIN_PATH ?? "axon", "run"]
