...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Wade-DevCode/axon/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/axon...\n")
...
console.log("Fetching npm all-time downloads for axon-ai...\n")
const npmDownloads = await fetchNpmDownloads("axon-ai")
